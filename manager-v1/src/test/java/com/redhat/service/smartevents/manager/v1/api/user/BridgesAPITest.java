...
import static com.redhat.service.smartevents.manager.v1.TestConstants.DEFAULT_ERROR_HANDLER_PROCESSOR_NAME;
...
import static com.redhat.service.smartevents.manager.v1.utils.TestUtils.createKafkaAction;
...
public class BridgesAPITest {
    ...
    public void testCreateAndGetBridge() {
        ...
        assertThat(bridgeResponse.getHref()).isEqualTo(V1_USER_API_BASE_PATH + bridgeResponse.getId());
    ...
    public void testGetBridgesFilterByMultipleStatuses() {
        ...
        assertThat(bridgeResponse1.getHref()).isEqualTo(V1_USER_API_BASE_PATH + bridgeResponse1.getId());
        ...
        assertThat(bridgeResponse2.getHref()).isEqualTo(V1_USER_API_BASE_PATH + bridgeResponse2.getId());
