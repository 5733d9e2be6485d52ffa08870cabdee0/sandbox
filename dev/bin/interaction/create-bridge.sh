...
NEW_BRIDGE_ID=$(curl -s -X POST -H "Authorization: $OB_TOKEN" -H 'Accept: application/json' -H 'Content-Type: application/json' -d "$bridge_payload" $MANAGER_URL/api/v1/bridges | jq -r .id)
