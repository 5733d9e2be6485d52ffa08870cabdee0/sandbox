...
def create_bridge():
    while True:
        if (random.random() < 0.2 and bridges): # with probability 0.2 create a bad request
...
def create_processor():
    while True:
        ...
        if (random.random() < 0.2): # with probability 0.2 create a bad request
...
def get_cloud_event():
    ...
    cloud_event = {
        ...
        "dataschema": "#",
        "data": {
            "api": "OtherOperation" if random.random() < 0.2 else "PutBlockList",
