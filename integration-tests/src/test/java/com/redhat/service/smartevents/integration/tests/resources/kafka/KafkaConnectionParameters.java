...
public class KafkaConnectionParameters {
    ...
    private static final String AUTH_SERVER_URL_PROPERTY = "event-bridge.rhoas.sso.mas.auth-server-url";
    private static final String KAFKA_BOOTSTRAP_SERVERS_PROPERTY = "event-bridge.kafka.bootstrap.servers";
    private static final String KAFKA_ADMIN_CLIENT_ID_PROPERTY = "event-bridge.rhoas.sso.mas.client-id";
    private static final String KAFKA_ADMIN_CLIENT_SECRET_PROPERTY = "event-bridge.rhoas.sso.mas.client-secret";
    private static final String KAFKA_OPS_CLIENT_ID_PROPERTY = "event-bridge.kafka.client.id";
    private static final String KAFKA_OPS_CLIENT_SECRET_PROPERTY = "event-bridge.kafka.client.secret";
