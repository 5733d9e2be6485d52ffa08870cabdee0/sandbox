...
There is a dedicated Maven profile named `performance` located in `integration-tests/manager-integration-tests/manager-integration-tests-v1/pom.xml`. There you can see the following system properties needed 
