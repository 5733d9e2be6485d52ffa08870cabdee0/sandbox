...
import com.redhat.service.smartevents.integration.tests.v1.resources.ProcessorResource;
...
public class ProcessorSteps {
    ...
    public void addProcessorToBridgeWithBodyIsFailingWithHTTPResponseCode(String testBridgeName, int responseCode, String processorRequestJson) {
        BridgeContext bridgeContext = context.getBridge(testBridgeName);
    ...
    public void processorOfBridgeIsExistingWithStatusWithinMinutes(String processorName, String testBridgeName, String status, int timeoutMinutes) {
        ...
        Awaitility.await()
                ...
                .failFast("Failed to create a Processor", () -> ProcessorResource
                        .getProcessorResponse(context.getManagerToken(), bridgeContext.getId(), processorId)
                        .then()
    ...
    public void processorOfBridgeHasActionOfType(String processorName, String testBridgeName, String processorType, String processorTypeValue) {
