...
public class KnativeCondition {
    ...
    private final KnativeBrokerConditionType type;
    ...
    @JsonCreator
    public KnativeCondition(@JsonProperty("type") final KnativeBrokerConditionType type, @JsonProperty("status") final ConditionStatus status) {
        this.type = type;
        this.status = status;
    }

    public KnativeCondition(final KnativeBrokerConditionType type) {
        this(type, ConditionStatus.Unknown);
    }

    public KnativeBrokerConditionType getType() {
        return type;
    }
    ...
    public boolean equals(Object o) {
        ...
        KnativeCondition condition = (KnativeCondition) o;
