...
public final class LabelsBuilder {
    ...
    public static final String APPLICATION_TYPE = "app.kubernetes.io/application-type";
    ...
    /**
     * The application type. Example "brigeIngress", "executor".
     */
    public LabelsBuilder withApplicationType(String applicationType) {
        this.labels.put(APPLICATION_TYPE, applicationType);
        return this;
    }
