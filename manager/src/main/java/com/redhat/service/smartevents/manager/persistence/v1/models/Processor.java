...
@FilterDefs({
        ...
        @FilterDef(name = "byStatus", parameters = { @ParamDef(name = "status", type = "com.redhat.service.smartevents.manager.persistence.EnumTypeManagedResourceStatus") }),
        @FilterDef(name = "byType", parameters = { @ParamDef(name = "ptype", type = "com.redhat.service.smartevents.manager.persistence.EnumTypeProcessorType") })
})
@Filters({
