...
public class ConnectorWorker extends AbstractWorker<ConnectorEntity> {
    ...
    private ConnectorEntity deployConnector(ConnectorEntity connectorEntity) {
        ...
        JsonNode connectorDefinition = connectorsService.createConnectorDefinition(connectorEntity.getId());
        Connector connector = connectorsApi.createConnector(connectorEntity, connectorDefinition);
