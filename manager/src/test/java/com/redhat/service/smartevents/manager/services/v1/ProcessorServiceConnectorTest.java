...
import com.redhat.service.smartevents.manager.RhoasServiceImpl;
...
class ProcessorServiceConnectorTest {
    ...
    void createConnectorSuccess() {
        ...
        Processor processor = processorService.createProcessor(b.getId(), b.getCustomerId(), b.getOwner(), b.getOrganisationId(), processorRequest);
