...
import static com.redhat.service.smartevents.manager.api.v1.user.validators.processors.ProcessorGatewayConstraintValidator.GATEWAY_CLASS_PARAM;
import static com.redhat.service.smartevents.manager.api.v1.user.validators.processors.ProcessorGatewayConstraintValidator.GATEWAY_PARAMETERS_MISSING_ERROR;
import static com.redhat.service.smartevents.manager.api.v1.user.validators.processors.ProcessorGatewayConstraintValidator.GATEWAY_TYPE_MISSING_ERROR;
import static com.redhat.service.smartevents.manager.api.v1.user.validators.processors.ProcessorGatewayConstraintValidator.MISSING_GATEWAY_ERROR;
import static com.redhat.service.smartevents.manager.api.v1.user.validators.processors.ProcessorGatewayConstraintValidator.MULTIPLE_GATEWAY_ERROR;
import static com.redhat.service.smartevents.manager.api.v1.user.validators.processors.ProcessorGatewayConstraintValidator.SOURCE_PROCESSOR_WITH_TRANSFORMATION_ERROR;
import static com.redhat.service.smartevents.manager.api.v1.user.validators.processors.ProcessorGatewayConstraintValidator.TYPE_PARAM;
