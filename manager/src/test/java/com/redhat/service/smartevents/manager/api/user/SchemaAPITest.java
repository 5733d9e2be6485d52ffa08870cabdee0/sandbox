...
public class SchemaAPITest {
    ...
    private static final List<String> availableActions = List.of("kafka_topic_sink_0.1", "send_to_bridge_sink_0.1", "slack_sink_0.1", "webhook_sink_0.1", "azure_eventhubs_sink_0.1");
