...
public class ProcessorServiceTest {
    ...
    public void testUpdateProcessorStatusReadyPublishedAt() {
        ...
        Processor retrievedProcessor = processorService.getProcessor(processor.getId(), b);
        ...
        Processor publishedProcessor = processorService.getProcessor(processor.getId(), b);
        ...
        Processor publishedProcessor2 = processorService.getProcessor(processor.getId(), b);
    ...
    private void waitForConnectorToBeDeleted(final Bridge bridge, final Processor processor) {
        ...
        await().atMost(15, SECONDS).untilAsserted(() -> {
            ...
            final Processor processorDeleted = processorService.getProcessor(processor.getId(), bridge);
