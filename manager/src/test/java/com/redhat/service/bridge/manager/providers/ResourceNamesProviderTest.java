...
import static com.redhat.service.bridge.manager.providers.ResourceNamesProviderImpl.BRIDGE_SHORTNAME;
import static com.redhat.service.bridge.manager.providers.ResourceNamesProviderImpl.PROCESSOR_SHORTNAME;
...
class ResourceNamesProviderTest {
    ...
    void testValidPrefix(String prefix, String expectedValidatedPrefix) {
        ...
        assertThat(bridgeTopicName).isEqualTo(expectedValidatedPrefix + BRIDGE_SHORTNAME + "-" + TEST_BRIDGE_ID);
        ...
        assertThat(processorConnectorName).isEqualTo(expectedValidatedPrefix + PROCESSOR_SHORTNAME + "-" + TEST_PROCESSOR_ID);
        ...
        assertThat(processorTopicName).isEqualTo(expectedValidatedPrefix + PROCESSOR_SHORTNAME + "-" + TEST_PROCESSOR_ID);
    }
