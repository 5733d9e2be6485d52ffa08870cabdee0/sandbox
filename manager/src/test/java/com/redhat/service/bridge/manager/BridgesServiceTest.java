...
public class BridgesServiceTest {
    ...
    public void testGetEmptyBridgesToDeploy() {
        List<Bridge> bridges = bridgesService.getBridgesByStatuses(Collections.singletonList(BridgeStatus.ACCEPTED));
    ...
    public void testCreateBridge() {
        ...
        List<Bridge> bridgesToDeploy = bridgesService.getBridgesByStatuses(Collections.singletonList(BridgeStatus.ACCEPTED));
    ...
    public void testUpdateBridgeStatus() {
        ...
        bridges = bridgesService.getBridgesByStatuses(Collections.singletonList(BridgeStatus.ACCEPTED));
        assertThat(bridges.size()).isZero();
