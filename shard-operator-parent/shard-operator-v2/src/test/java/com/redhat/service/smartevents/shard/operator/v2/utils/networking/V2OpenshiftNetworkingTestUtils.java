...
public class V2OpenshiftNetworkingTestUtils implements V2NetworkingTestUtils {

    private final OpenShiftClient client;

    public V2OpenshiftNetworkingTestUtils(OpenShiftClient client) {
        this.client = client;
    ...
    private void patchOpenshiftIngressDomain() {
        Ingress openshiftIngress = new IngressBuilder()
                ...
                .withSpec(new IngressSpecBuilder().withDomain(V2NetworkingTestConstants.HOST_ADDRESS).build())
                .build();
