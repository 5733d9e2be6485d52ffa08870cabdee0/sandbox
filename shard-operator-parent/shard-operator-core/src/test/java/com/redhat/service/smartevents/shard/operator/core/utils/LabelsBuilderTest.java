...
public class LabelsBuilderTest {
    ...
    public void buildWithDefaults() {
        ...
        assertThat(new LabelsBuilder().buildWithDefaults(LabelsBuilder.V2_OPERATOR_NAME)).containsEntry(LabelsBuilder.MANAGED_BY_LABEL, LabelsBuilder.V2_OPERATOR_NAME)
                .containsEntry(LabelsBuilder.CREATED_BY_LABEL, LabelsBuilder.V2_OPERATOR_NAME);
