...
public abstract class AbstractIdentityResolverImpl implements IdentityResolver {

    private static final Logger LOGGER = LoggerFactory.getLogger(AbstractIdentityResolverImpl.class);
    ...
    public String resolve(JsonWebToken jwt) {
        ...
        throw getForbiddenRequestException(String.format("The token is valid but it does not contain '%s' nor '%s' claim.",
                APIConstants.ACCOUNT_ID_USER_ATTRIBUTE_CLAIM,
                APIConstants.ACCOUNT_ID_SERVICE_ACCOUNT_ATTRIBUTE_CLAIM));
    }

    protected abstract ExternalUserException getForbiddenRequestException(String message);
    ...
    public String resolveOrganisationId(JsonWebToken jwt) {
        ...
        throw getForbiddenRequestException(String.format("The token is valid but it does not contain '%s' nor '%s' claim..",
                APIConstants.ORG_ID_USER_ATTRIBUTE_CLAIM,
