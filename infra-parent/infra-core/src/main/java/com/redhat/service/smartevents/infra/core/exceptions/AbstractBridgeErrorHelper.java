...
public abstract class AbstractBridgeErrorHelper implements BridgeErrorHelper {

    private static final Logger LOGGER = LoggerFactory.getLogger(AbstractBridgeErrorHelper.class);
    ...
    private BridgeError deploymentFailedException;

    protected AbstractBridgeErrorHelper() {
        //CDI proxy
    }

    protected AbstractBridgeErrorHelper(BridgeErrorService bridgeErrorService) {
