...
public class BridgeErrorInMemoryDAOTest {
    ...
    private static BridgeErrorDAO dao;

    @BeforeAll
    public static void setup() {
        dao = new BridgeErrorInMemoryDAO();
        ((BridgeErrorInMemoryDAO) dao).init();
    }
    ...
    void testFindByExceptionClass() {
        ...
        assertThat(error).isNotNull();
        assertThat(error.getId()).isEqualTo(3);
    ...
    private static Stream<Arguments> findErrorByIdAndType() {
        return Stream.of(
                ...
                Arguments.of(11, BridgeErrorType.PLATFORM, false),
                Arguments.of(11, BridgeErrorType.USER, true),
